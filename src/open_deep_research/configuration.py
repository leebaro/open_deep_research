...
class Configuration:
    ...
    planner_provider: PlannerProvider = PlannerProvider.GOOGLE  # Defaults to Anthropic as provider
    planner_model: str = "gemini-2.0-flash-001" # Defaults to gemini-1.5-flash-latest
    ...
    writer_provider: WriterProvider = WriterProvider.GOOGLE  # Defaults to Anthropic as provider
    writer_model: str = "gemini-2.0-flash-001" # Defaults to gemini-1.5-flash-latest
